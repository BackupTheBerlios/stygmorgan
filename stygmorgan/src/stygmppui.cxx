...
Fl_Double_Window* rmgmpp::make_window() {
  ...
  { Fl_Double_Window* o = rmgmppwin = new Fl_Double_Window(830, 335);
    ...
    { Fl_Choice* o = PatChoice = new Fl_Choice(10, 25, 150, 25, gettext("Original Channel/Track"));
      o->down_box(FL_BORDER_BOX);
      o->labelsize(11);
      o->callback((Fl_Callback*)cb_PatChoice);
      o->align(FL_ALIGN_TOP_LEFT);
    }
    { Fl_Counter* o = DChannel = new Fl_Counter(10, 75, 100, 25, gettext("Dest. Channel"));
      o->type(1);
    ...
    { Fl_Counter* o = ChordRoot = new Fl_Counter(10, 120, 100, 25, gettext("Chord Root"));
      o->type(1);
      o->box(FL_PLASTIC_DOWN_BOX);
      o->labelsize(11);
      o->minimum(1);
    ...
    { Fl_Counter* o = ChordType = new Fl_Counter(10, 165, 100, 25, gettext("Chord Type"));
      o->type(1);
      o->box(FL_PLASTIC_DOWN_BOX);
      o->labelsize(11);
      o->minimum(0);
    ...
    { Fl_Counter* o = NTT = new Fl_Counter(10, 210, 100, 25, gettext("NTT"));
      o->type(1);
      o->box(FL_PLASTIC_DOWN_BOX);
      o->labelsize(11);
      o->minimum(1);
    ...
    { Fl_Counter* o = RTR = new Fl_Counter(10, 255, 100, 25, gettext("RTR"));
      o->type(1);
      o->box(FL_PLASTIC_DOWN_BOX);
      o->labelsize(11);
      o->minimum(1);
