...
Fl_Double_Window* rmgmpref::make_window() {
  { rmgmprefwin = new Fl_Double_Window(540, 505);
    rmgmprefwin->color(FL_BACKGROUND2_COLOR);
    ...
    { ASF = new Fl_Check_Button(5, 215, 245, 25, gettext("Use asfxload to load soundfont at startup?"));
    ...
    { ASFGroup = new Fl_Group(5, 230, 530, 50);
      { SFPath = new Fl_File_Input(5, 250, 530, 30, gettext("SoundFont"));
        SFPath->labelsize(11);
        SFPath->align(FL_ALIGN_TOP_LEFT);
    ...
    { TempFilesDir = new Fl_File_Input(5, 305, 530, 30, gettext("Directory for temporal files"));
      ...
      TempFilesDir->align(FL_ALIGN_TOP_LEFT);
    } // Fl_File_Input* TempFilesDir
    { Fl_Button* o = new Fl_Button(470, 280, 65, 20, gettext("Browse"));
      o->labelsize(11);
      o->callback((Fl_Callback*)cb_Browse1);
    } // Fl_Button* o
    { DRespect = new Fl_Check_Button(5, 470, 270, 25, gettext("Maintain Mutes when pattern changes"));
      DRespect->down_box(FL_DOWN_BOX);
      DRespect->labelsize(11);
    ...
    { DTextStart = new Fl_Input(5, 385, 465, 25, gettext("SysEx for Start button "));
      ...
      DTextStart->align(FL_ALIGN_TOP_LEFT);
    } // Fl_Input* DTextStart
    { DTextAutoF = new Fl_Input(5, 430, 465, 25, gettext("SysEx for Auto Fill-In button "));
      ...
      DTextAutoF->align(FL_ALIGN_TOP_LEFT);
    } // Fl_Input* DTextAutoF
    rmgmprefwin->end();
