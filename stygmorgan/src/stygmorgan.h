...
char TextAUTOF[128];
  ...
  int tvb[22];
  int nb;
  char StylesFilename[128],SoundsFilename[128],PresetFilename[128],DrumSetFilename[128],ASFFilename[128],RegisFilename[128];
  char TempDir[128];
  int negra,onegra;
