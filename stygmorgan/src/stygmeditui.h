...
private:
  void cb_Eventwin_i(Fl_Double_Window*, void*);
...
public:
  ...
  Fl_Counter *SlPos;
private:
  void cb_SlPos_i(Fl_Counter*, void*);
  static void cb_SlPos(Fl_Counter*, void*);
public:
  Fl_Box *NotaDis;
  Fl_Counter *SlNote;
private:
  void cb_SlNote_i(Fl_Counter*, void*);
