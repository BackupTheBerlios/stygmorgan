  ...
  { stygmseqwin = new Fl_Double_Window(800, 600);
    ...
    { Displays = new Fl_Group(0, 465, 800, 135);
      ...
      { NomChord = new Fl_Box(560, 520, 145, 40, gettext("C"));
        ...
        NomChord->align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
      } // Fl_Box* NomChord
      ...
      { NomStyle = new Fl_Box(450, 470, 255, 45);
        ...
        NomStyle->align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
      } // Fl_Box* NomStyle
      { NomPattern = new Fl_Box(450, 520, 105, 40, gettext("Fill In AB"));
        ...
        NomPattern->align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
      } // Fl_Box* NomPattern
      Displays->end();
    } // Fl_Group* Displays
